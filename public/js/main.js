...
$(document).ready(function () {
  ...
  var rerenderFilesContainer = function rerenderFilesContainer() {
    $imagesContainer.html('');

    for (var i = 0; i < files.length; i++) {
      var template = "<div class=\"images-container__item\" data-img-id=\"".concat(i, "\">\n                    <img src=\"").concat(files[i], "\">\n                    <div class=\"images-container__item__remove\">\u0423\u0434\u0430\u043B\u0438\u0442\u044C</div>\n                </div>");
    ...
    removeBtn.bind('click', function (e) {
      var currentDelBtn = $(e.currentTarget);
      var imageItem = currentDelBtn.parent('.images-container__item');
      var imgId = imageItem.data('img-id');
